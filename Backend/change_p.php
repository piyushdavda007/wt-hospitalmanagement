...
<div id="apDiv13" onMouseOver="show3()" onMouseOut="hide3()">
  ...
  <div id="apDiv16">
  <?php
  $con=mysqli_connect("localhost","root","comrade");
  mysql_select_db("hospital",$con);
  $a=$_POST['o_pass'];
  $b=$_POST['new_pass'];
  $c=$_POST['conf_pass'];
  $uid=$_SESSION['id'];
  $qry=mysqli_query($conn,"select * from admin where Username='$uid'");
  $flag=0;
...
if($flag==1)
{
	$qry1=mysqli_query($conn,"update admin set Password='$b' where Username='$uid'");
