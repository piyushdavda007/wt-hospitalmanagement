...
<div id="apDiv12"><hr>
  <div id="apDiv15">
  	<?php
		...
		$uid=$_SESSION['id'];
		$qry=mysqli_query($conn,"select dimage from doctor where doctorID='$uid'");
  ...
  <?php
 	include("connection.php");
	$uid=$_SESSION['id'];
	$qry=mysqli_query($conn,"select dname from doctor where doctorID='$uid'");
	while($row=mysql_fetch_array($qry))
	{
...
<div align="center">
  <?php
	...
	$date1=$_POST['date'];
	$time1=$_POST['time'];
	$qry=mysqli_query($conn,"update history set details='$detail',date='$date1',time='$time1' where patientID='$pid1' and doctorID='$did'");
	if($qry)
	{
